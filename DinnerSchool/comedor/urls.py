...
urlpatterns = [
    ...
    path("order/direct/", views.directSale, name="createDirectOrder"),
    ...
    path("orden/<int:orden_id>/cancel/", views.cancelOrden, name="cancelOrden"),
    path('order/<int:orden_id>/details/', views.order_details_api, name='order_details_api'),
    path('order/<int:orden_id>/modify/', views.modify_order_view, name='modify_order'),
